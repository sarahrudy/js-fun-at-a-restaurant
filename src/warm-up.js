...
// We got a new shipment! Use a built in math operator to make the inStock count double what it currently is.

console.log(inStock = inStock * 2)
...
var vegetables;
vegetables = ['zucchini', 'carrots', 'broccoli', 'peppers', 'tomatoes']
...
var fruits;
fruits = ['bananas', 'apples', 'strawberries', 'oranges', 'avocados', 'lemons', 'watermelon']
...
// Create a new variable called "groceryStore" and assign to it an object literal with two keys: name, and isOpen. The value for name should the string 'King Soopers' (or your favorite grocery store), and the value for isOpen should be true.
...
// repl.it link: https://replit.com/@SarahRudy/FunAtARestaurantWarmUp
